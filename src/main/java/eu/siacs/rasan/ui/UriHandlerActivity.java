...
import eu.siacs.rasan.databinding.ActivityUriHandlerBinding;
...
import eu.siacs.rasan.utils.ProvisioningUtils;
...
public class UriHandlerActivity extends AppCompatActivity {
    ...
    private static Class<?> findShareViaAccountClass() {
        try {
            return Class.forName("eu.siacs.rasan.ui.ShareViaAccountActivity");
