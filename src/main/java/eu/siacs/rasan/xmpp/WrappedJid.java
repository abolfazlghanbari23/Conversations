...
public class WrappedJid implements eu.siacs.rasan.xmpp.Jid {
    ...
    @Override
    public eu.siacs.rasan.xmpp.Jid asBareJid() {
        return new WrappedJid(inner.asBareJid());
    }

    @Override
    public eu.siacs.rasan.xmpp.Jid withResource(CharSequence resource) {
    ...
    @Override
    public eu.siacs.rasan.xmpp.Jid getDomain() {
    ...
    @Override
    public int compareTo(eu.siacs.rasan.xmpp.Jid jid) {
